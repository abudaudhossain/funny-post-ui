...
export default function Article() {
    return (
        <Link to="/details" style={{fontWeight:"0p", margin: 0, padding: 0}}>
            <div className='article' style={{margin: "0px 0"}}>
                <div className='img-container' >
                    <img src={img} style={{ width: "60px", height: "60px" }} />
                </div>
                <div className='px-4'>
                    <Text preset='sub-title' style={{ fontWeight: 700}}>This is thitle</Text>
                    <div style={{ color: "#bfbfbf", fontFamily: "Poppins, Arial, serif", fontSize: "14px" }}>
                        ...
                        <span className='me-2'><i className="fa-solid fa-user p-1"></i>Abu Daud</span>
